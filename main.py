...
search_box = wait.until(visibility_of_element_located((By.CSS_SELECTOR, "[title='Search']")))
...
signin_button = wait.until(visibility_of_element_located((By.CSS_SELECTOR, ".gb_id")))
assert signin_button.text == "Sign in"

search_button: WebElement = wait.until(visibility_of_element_located((By.CSS_SELECTOR, ".FPdoLc > center:nth-child(1) > input:nth-child(1)")))
